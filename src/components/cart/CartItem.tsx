...
const MemoDeleteBtn = React.memo(({ handleDel }: { handleDel: () => void }) => (
...
const MemoIncreaseBtn = React.memo(({ handleIncrease }: { handleIncrease: () => void }) => (
  <button
    ...
    <>
      <div className="flex justify-between items-center w-full">
        <div className="flex justify-between items-center w-[220px] lg:w-[260px] gap-4 pl-2">
          <MemoImg handleImg={handleImg} img={img} title={title} />
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-center gap-3">
              ...
              <MemoIncreaseBtn handleIncrease={handleIncrease} />
            </div>
          </div>
        </div>
